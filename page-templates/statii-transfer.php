		...
		<div class="row">
			<div class="col-lg-12 text-center">
				<div class="section-title center">
					...
					<h3><?php the_title();?> din judetul Vrancea si localitatile arondate.</h3>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="align-items-center">
				...
				<div class="about-text">
					<h4 class="text-center"><?php the_field('titlu_statie_platforma'); ?></h4>
					<span><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/assets/images/home2/shape.png" alt=""></span><a href="#"> Deseuri care pot fi depuse:</a>
				</div>
				<br/>
				<div class="about-list-item">
					<ul>
						<?php if(have_rows('deseuri')):?>
							<?php while(have_rows('deseuri')): the_row();
								$deseuri = get_sub_field('denumire_deseuri');
							?>
								<li><i class="bi bi-check"></i><?php echo $deseuri; ?></li>
							<?php endwhile;?>
						<?php endif;?>
					</ul>
				</div>
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						...
						if (have_rows('localitati_arondate')):
							...
							while (have_rows('localitati_arondate')):
								...
								$main_title = get_sub_field('statie_transfer');
			...
			<div class="col-lg-12">
				<div class="tab-content" id="pills-tabContent">
					<?php if (have_rows('localitati_arondate')):
										...
										<div class="single-event">
											<div class="single-event-box">
												...
												<h4><?php echo $main_title; ?></h4>
																	...
																	<div class="row gallery-row" style="margin-bottom: 10px;">
																		<?php foreach ($image_row as $image_id): ?>
																			<div class="col-lg-4 col-md-4 col-sm-6 gallery-item">
																				...
																				?>
																				<a href="<?php echo esc_url($full_image_url); ?>" class="venobox" data-gall="gallery-<?php  echo $main_title ?>" data-title="Your Image Caption"> <img src="<?php echo esc_url($image_url); ?>" class="img-fluid">
																				</a>
																			</div>
																		<?php endforeach; ?>
																	</div>
													...
													<?php if(get_sub_field('localitati_arondate')):?>
						...
						<p>No data found for localitati arondate.</p>
					<?php endif; ?>
				</div>
			</div>
